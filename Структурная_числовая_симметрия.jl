...
return (  # Возвращаем именованный кортеж (NamedTuple) с результатами проверки гипотезы
...
# Запуск тестов
run_tests_parallel(start_N, stop_N, m, k)  # Вызываем основную функцию для параллельной проверки гипотезы
